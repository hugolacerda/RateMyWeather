                ...
                <div class="row">
                    <div class="focus-font">
                        <div class="span1">
                            ...
                            <form action="controllers/formSubmit.php" enctype="multipart/form-data" method="post">
                                <input id="thumbs_up" type="submit" value="" name="good">
                            </form>
                            </span>
                            <!-- <span class="icon-stack"> -->
                        </div>
                        <div class="span1">
                            <span class="icon-stack">
                            <form action="controllers/formSubmit.php" enctype="multipart/form-data" method="post">
                                <input id="thumbs_down" type="submit" value="" name="bad">
                            </form>
                            </span>
